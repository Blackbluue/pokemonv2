# data acquired from https://bulbapedia.bulbagarden.net/wiki/Ability#List_of_Abilities

data = """1:Stench:By releasing a stench when attacking, the Pokémon may cause the target to flinch.:III
...
keys = ["id", "name", "text", "gen"]
separator = ":"

abilities = [dict(zip(keys, d)) for d in [
    d.split(sep=separator) for d in data.split(sep="\n")
]]
